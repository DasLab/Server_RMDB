...
urlpatterns = patterns('',
    ...
    (r'^tools/$', views.tools),
    (r'^tools/(?P<keyword>\w+)/license/$', views.tools_license),
    (r'^tools/(?P<keyword>\w+)/download/$', views.tools_download),

    (r'^tools/docs/(?P<keyword>\w+)/$', views.tutorial),
    (r'^rdatkit/$', views.tutorial, {'keyword':'rdatkit'}),
    (r'^hitrace/$', views.tutorial, {'keyword':'hitrace'}),
    (r'^mapseeker/$', views.tutorial, {'keyword':'mapseeker'}),
    (r'^reeffit/$', views.tutorial, {'keyword':'reeffit'}),
