...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RMDBEntry.date'
        db.delete_column('repository_rmdbentry', 'date')

        # Adding field 'RMDBEntry.creation_date'
        db.add_column('repository_rmdbentry', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'RMDBEntry.date'
        db.add_column('repository_rmdbentry', 'date', self.gf('django.db.models.fields.DateField')(auto_now=True, null=True, blank=True), keep_default=False)

        # Deleting field 'RMDBEntry.creation_date'
        db.delete_column('repository_rmdbentry', 'creation_date')
