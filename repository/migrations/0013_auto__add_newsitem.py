...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('repository_newsitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.TextField')()),
            ('reference', self.gf('django.db.models.fields.CharField')(max_length=400, blank=True)),
            ('date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('repository', ['NewsItem'])


    def backwards(self, orm):
        
        # Deleting model 'NewsItem'
        db.delete_table('repository_newsitem')
