...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DataAnnotation.value'
        db.alter_column('repository_dataannotation', 'value', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'DataAnnotation.value'
        db.alter_column('repository_dataannotation', 'value', self.gf('django.db.models.fields.CharField')(max_length=255))
