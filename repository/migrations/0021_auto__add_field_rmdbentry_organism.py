...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RMDBEntry.organism'
        db.add_column('repository_rmdbentry', 'organism', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['repository.Organism'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RMDBEntry.organism'
        db.delete_column('repository_rmdbentry', 'organism_id')
    ...
    models = {
        ...
        'repository.rmdbentry': {
            ...
            'organism': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['repository.Organism']", 'null': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'}),
            'pdb_entries': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
