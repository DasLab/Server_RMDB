...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataSection.structure'
        db.add_column('repository_datasection', 'structure', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DataSection.structure'
        db.delete_column('repository_datasection', 'structure')
