...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RMDBEntry.latest'
        db.add_column('repository_rmdbentry', 'latest', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RMDBEntry.latest'
        db.delete_column('repository_rmdbentry', 'latest')
