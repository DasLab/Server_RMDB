...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RMDBEntry.rmdb_id'
        db.add_column('repository_rmdbentry', 'rmdb_id', self.gf('django.db.models.fields.CharField')(max_length=6, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RMDBEntry.rmdb_id'
        db.delete_column('repository_rmdbentry', 'rmdb_id')
