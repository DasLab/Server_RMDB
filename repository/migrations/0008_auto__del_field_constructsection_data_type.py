...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ConstructSection.data_type'
        db.delete_column('repository_constructsection', 'data_type')


    def backwards(self, orm):
        
        # Adding field 'ConstructSection.data_type'
        db.add_column('repository_constructsection', 'data_type', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
