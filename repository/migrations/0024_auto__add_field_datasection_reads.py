...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataSection.reads'
        db.add_column('repository_datasection', 'reads', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DataSection.reads'
        db.delete_column('repository_datasection', 'reads')
    ...
    models = {
        ...
        'repository.datasection': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reads': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'seqpos': ('django.db.models.fields.TextField', [], {}),
        ...
        'repository.organism': {
            ...
            'taxonomy_id': ('django.db.models.fields.TextField', [], {})
        },
        ...
        'repository.rmdbentry': {
            ...
            'organism': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['repository.Organism']", 'null': 'True', 'blank': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True'}),
            'pdb_entries': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
