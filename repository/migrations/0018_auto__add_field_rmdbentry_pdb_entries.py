...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RMDBEntry.pdb_entries'
        db.add_column('repository_rmdbentry', 'pdb_entries', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RMDBEntry.pdb_entries'
        db.delete_column('repository_rmdbentry', 'pdb_entries')
