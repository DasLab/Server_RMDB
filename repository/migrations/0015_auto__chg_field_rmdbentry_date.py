...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RMDBEntry.date'
        db.alter_column('repository_rmdbentry', 'date', self.gf('django.db.models.fields.DateField')(auto_now=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'RMDBEntry.date'
        db.alter_column('repository_rmdbentry', 'date', self.gf('django.db.models.fields.DateField')(null=True))
