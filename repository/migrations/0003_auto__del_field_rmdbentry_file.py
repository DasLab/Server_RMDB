...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RMDBEntry.file'
        db.delete_column('repository_rmdbentry', 'file')


    def backwards(self, orm):
        
        # Adding field 'RMDBEntry.file'
        db.add_column('repository_rmdbentry', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True), keep_default=False)
