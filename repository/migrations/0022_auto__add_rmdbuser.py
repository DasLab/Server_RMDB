...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RMDBUser'
        db.create_table('repository_rmdbuser', (
        ...
        db.send_create_signal('repository', ['RMDBUser'])


    def backwards(self, orm):
        
        # Deleting model 'RMDBUser'
        db.delete_table('repository_rmdbuser')
