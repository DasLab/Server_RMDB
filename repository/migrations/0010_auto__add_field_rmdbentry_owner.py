...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RMDBEntry.owner'
        db.add_column('repository_rmdbentry', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RMDBEntry.owner'
        db.delete_column('repository_rmdbentry', 'owner_id')
