...
public class VARNAConfig implements Serializable, Cloneable {
	...
	public static final double DEFAULT_BP_THICKNESS = 3.0;
	...
	public static final Font DEFAULT_BASE_FONT = new Font("SansSerif", Font.BOLD, 20);
	public static final Font DEFAULT_NUMBERS_FONT = new Font("SansSerif",
			Font.BOLD, 18);
	public static final BP_STYLE DEFAULT_BP_STYLE = BP_STYLE.BP_STYLE_SIMPLE;
	...
	public double _bpThickness = DEFAULT_BP_THICKNESS;
	...
	public boolean _drawOutlineBase = false;
	public boolean _fillBase = false;
