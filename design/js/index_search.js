function fill_category_list(data, tag) {
	if (tag == "Eterna") {
		...
		for (c in data) {
			pan_html += '<tr><td class="text-right"><p class="lead"><span class="label label-default" style="background:#000;">RMDB_ID</span></p><p class="lead"><span class="label label-danger">experimentType</span></p><p class="lead"><span class="label label-violet">Stats</span></p></td><td><p class="lead"><a href="/repository/detail/' + data[c].rmdb_id + '"><span class="label label-default">' + colorRmdbId(data[c].rmdb_id) + '</span></a></p><p class="lead"><span class="label label-success">Standard State</span></p><i>Version:</i> <mark>' + data[c].version + '</mark><br/><i># of Construct:</i> <code>' + data[c].construct_count + '</code><br/><i># of Data point:</i> <code>' + data[c].data_count + '</code></p></td><td id="' + data[c].rmdb_id + '" class="eterna-subpanel"><div style="height:220px;overflow:hidden;"><a href="/repository/detail/' + data[c].rmdb_id + '" class="row browse-rotate thumbnail pull-left" style="left:-300px;"><img src="/site_data/thumbs/' + data[c].cid + '/' + convertToSlug(data[c].name) + '.gif"/></a></div></td></tr>';
		}
	} else {
		...
		for (c in data) {
			pan_html += '<tr><td class="text-right"><p class="lead"><span class="label label-default" style="background:#000;">RMDB_ID</span></p><p class="lead"><span class="label label-danger">experimentType</span></p><p class="lead"><span class="label label-violet">Stats</span></p></td><td><p class="lead"><a href="/repository/detail/' + data[c].rmdb_id + '"><span class="label label-default">' + colorRmdbId(data[c].rmdb_id) + '</span></a></p><p class="lead"><span class="label label-success">Standard State</span></p><i>Version:</i> <mark>' + data[c].version + '</mark><br/><i># of Construct:</i> <code>'+ data[c].construct_count + '</code><br/><i># of Data point:</i> <code>' + data[c].data_count + '</code></p></td><td><p><span class="lead"><span class="label label-brown">Publication</span></span></p><p><i>' + data[c].authors + '</i>. <b>' + data[c].title + '</b>.</p><p><span class="lead"><span class="label label-primary">COMMENT</span></span></p><p class="excerpt">' + data[c].comments + '</p></td><td><a href="/repository/detail/' + data[c].rmdb_id + '" class="row thumbnail pull-left"><img src="/site_data/thumbs/' + data[c].cid + '/' + convertToSlug(data[c].name) + '.gif"/></a></td></tr>';
		}
	}
	pan_html += '</table>';
	return pan_html;
...
$(document).ready(function() {
	...
	$.ajax({
		...
		complete: function(xhr) {
			$.ajax({
				url: '/repository/api/index/search/general/' + search_word,
				dataType: 'json',
				async: true,
				success: function(data) { 
				...
				complete: function(xhr) {
					$.ajax({
						url: '/repository/api/index/search/eterna/' + search_word,
						dataType: 'json',
						async: true,
						success: function(data) { 
