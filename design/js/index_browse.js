	...
	for (c in data) {
		if (tag == "Eterna") {
			...
			if (data[c].SS_entry.length) {
				...
				for (e in data[c].SS_entry) {
					pan_html += '<div class="col-md-4 entry-list"><a href="/repository/detail/' + data[c].SS_entry[e].rmdb_id + '" class="thumbnail"><p class="lead" style="padding-top:10px;"><span class="label label-default">' + colorRmdbId(data[c].SS_entry[e].rmdb_id) + '</span></p><img src="/site_data/thumbs/' + data[c].SS_entry[e].cid + '.gif"/></a></div>';
				}
				pan_html += '</div>';
			}
			if (data[c].TT_entry.length) {
				...
				for (e in data[c].TT_entry) {
					pan_html += '<div class="col-md-4 entry-list"><a href="/repository/detail/' + data[c].TT_entry[e].rmdb_id + '" class="thumbnail"><p class="lead" style="padding-top:10px;"><span class="label label-default">' + colorRmdbId(data[c].TT_entry[e].rmdb_id) + '</span></p><img src="/site_data/thumbs/' + data[c].TT_entry[e].cid + '.gif"/></a></div>';
				}
				pan_html += '</div>';
			}
			if (data[c].MM_entry.length) {
				...
				for (e in data[c].MM_entry) {
					pan_html += '<div class="col-md-4 entry-list"><a href="/repository/detail/' + data[c].MM_entry[e].rmdb_id + '" class="thumbnail"><p class="lead" style="padding-top:10px;"><span class="label label-default">' + colorRmdbId(data[c].MM_entry[e].rmdb_id) + '</span></p><img src="/site_data/thumbs/' + data[c].MM_entry[e].cid + '.gif"/></a></div>';
				}
				pan_html += '</div>';
			}
			if (data[c].MA_entry.length) {
				...
				for (e in data[c].MA_entry) {
					pan_html += '<div class="col-md-4 entry-list"><a href="/repository/detail/' + data[c].MA_entry[e].rmdb_id + '" class="thumbnail"><p class="lead" style="padding-top:10px;"><span class="label label-default">' + colorRmdbId(data[c].MA_entry[e].rmdb_id) + '</span></p><img src="/site_data/thumbs/' + data[c].MA_entry[e].cid + '.gif"/></a></div>';
				}
				pan_html += '</div>';
			}
