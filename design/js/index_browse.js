	...
	for (c in data) {
		if (tag == "Eterna") {
			...
			if (data[c].SS_entry.length) {
				for (e in data[c].SS_entry) {
					pan_html += '<tr><td class="text-right"><p class="lead"><span class="label label-default" style="background:#000;">RMDB_ID</span></p><p class="lead"><span class="label label-danger">experimentType</span></p><p class="lead"><span class="label label-violet">Stats</span></p></td><td><p class="lead"><a href="/repository/detail/' + data[c].SS_entry[e].rmdb_id + '"><span class="label label-default">' + colorRmdbId(data[c].SS_entry[e].rmdb_id) + '</span></a></p><p class="lead"><span class="label label-success">Standard State</span></p><i>Version:</i> <mark>' + data[c].SS_entry[e].version + '</mark><br/><i># of Construct:</i> <code>' + data[c].SS_entry[e].construct_count + '</code><br/><i># of Data point:</i> <code>' + data[c].SS_entry[e].data_count + '</code></p></td><td><p><span class="lead"><span class="label label-brown">Publication</span></span></p><p><i>' + data[c].SS_entry[e].authors + '</i>. <b>' + data[c].SS_entry[e].title + '</b>.</p><p><span class="lead"><span class="label label-primary">COMMENT</span></span></p><p class="excerpt">' + data[c].SS_entry[e].comments + '</p></td><td><a href="/repository/detail/' + data[c].SS_entry[e].rmdb_id + '" class="row thumbnail pull-left"><img src="/site_data/thumbs/' + data[c].SS_entry[e].cid + '.gif"/></a><br/></td></tr>';
				}
			}
			if (data[c].TT_entry.length) {
				for (e in data[c].TT_entry) {
					pan_html += '<tr><td class="text-right"><p class="lead"><span class="label label-default" style="background:#000;">RMDB_ID</span></p><p class="lead"><span class="label label-danger">experimentType</span></p><p class="lead"><span class="label label-violet">Stats</span></p></td><td><p class="lead"><a href="/repository/detail/' + data[c].TT_entry[e].rmdb_id + '"><span class="label label-default">' + colorRmdbId(data[c].TT_entry[e].rmdb_id) + '</span></a></p><p class="lead"><span class="label label-success">Titration</span></p><i>Version:</i> <mark>' + data[c].TT_entry[e].version + '</mark><br/><i># of Construct:</i> <code>' + data[c].TT_entry[e].construct_count + '</code><br/><i># of Data point:</i> <code>' + data[c].TT_entry[e].data_count + '</code></p></td><td><p><span class="lead"><span class="label label-brown">Publication</span></span></p><p><i>' + data[c].TT_entry[e].authors + '</i>. <b>' + data[c].TT_entry[e].title + '</b>.</p><p><span class="lead"><span class="label label-primary">COMMENT</span></span></p><p class="excerpt">' + data[c].TT_entry[e].comments + '</p></td><td><a href="/repository/detail/' + data[c].TT_entry[e].rmdb_id + '" class="row thumbnail pull-left"><img src="/site_data/thumbs/' + data[c].TT_entry[e].cid + '.gif"/></a><br/></td></tr>';
				}
			}
			if (data[c].MM_entry.length) {
				for (e in data[c].MM_entry) {
					pan_html += '<tr><td class="text-right"><p class="lead"><span class="label label-default" style="background:#000;">RMDB_ID</span></p><p class="lead"><span class="label label-danger">experimentType</span></p><p class="lead"><span class="label label-violet">Stats</span></p></td><td><p class="lead"><a href="/repository/detail/' + data[c].MM_entry[e].rmdb_id + '"><span class="label label-default">' + colorRmdbId(data[c].MM_entry[e].rmdb_id) + '</span></a></p><p class="lead"><span class="label label-success">Mutate and Map</span></p><i>Version:</i> <mark>' + data[c].MM_entry[e].version + '</mark><br/><i># of Construct:</i> <code>' + data[c].MM_entry[e].construct_count + '</code><br/><i># of Data point:</i> <code>' + data[c].MM_entry[e].data_count + '</code></p></td><td><p><span class="lead"><span class="label label-brown">Publication</span></span></p><p><i>' + data[c].MM_entry[e].authors + '</i>. <b>' + data[c].MM_entry[e].title + '</b>.</p><p><span class="lead"><span class="label label-primary">COMMENT</span></span></p><p class="excerpt">' + data[c].MM_entry[e].comments + '</p></td><td><a href="/repository/detail/' + data[c].MM_entry[e].rmdb_id + '" class="row thumbnail pull-left"><img src="/site_data/thumbs/' + data[c].MM_entry[e].cid + '.gif"/></a><br/></td></tr>';
				}
			}
			if (data[c].MA_entry.length) {
				for (e in data[c].MA_entry) {
					pan_html += '<tr><td class="text-right"><p class="lead"><span class="label label-default" style="background:#000;">RMDB_ID</span></p><p class="lead"><span class="label label-danger">experimentType</span></p><p class="lead"><span class="label label-violet">Stats</span></p></td><td><p class="lead"><a href="/repository/detail/' + data[c].MA_entry[e].rmdb_id + '"><span class="label label-default">' + colorRmdbId(data[c].MA_entry[e].rmdb_id) + '</span></a></p><p class="lead"><span class="label label-success">MOHCA</span></p><i>Version:</i> <mark>' + data[c].MA_entry[e].version + '</mark><br/><i># of Construct:</i> <code>' + data[c].MA_entry[e].construct_count + '</code><br/><i># of Data point:</i> <code>' + data[c].MA_entry[e].data_count + '</code></p></td><td><p><span class="lead"><span class="label label-brown">Publication</span></span></p><p><i>' + data[c].MA_entry[e].authors + '</i>. <b>' + data[c].MA_entry[e].title + '</b>.</p><p><span class="lead"><span class="label label-primary">COMMENT</span></span></p><p class="excerpt">' + data[c].MA_entry[e].comments + '</p></td><td><a href="/repository/detail/' + data[c].MA_entry[e].rmdb_id + '" class="row thumbnail pull-left"><img src="/site_data/thumbs/' + data[c].MA_entry[e].cid + '.gif"/></a><br/></td></tr>';
				}
			}
	...
	for (c in data) {
		if (tag == "Eterna") {
			...
			if (data[c].SS_entry.length) {
				...
				for (e in data[c].SS_entry) {
					pan_html += '<div class="col-md-4 entry-list"><a href="/repository/detail/' + data[c].SS_entry[e].rmdb_id + '" class="thumbnail"><p class="lead" style="padding-top:10px;"><span class="label label-default">' + colorRmdbId(data[c].SS_entry[e].rmdb_id) + '</span></p><img src="/site_data/thumbs/' + data[c].SS_entry[e].cid + '.gif"/><br/></a></div>';
				}
				pan_html += '</div>';
			}
			if (data[c].TT_entry.length) {
				...
				for (e in data[c].TT_entry) {
					pan_html += '<div class="col-md-4 entry-list"><a href="/repository/detail/' + data[c].TT_entry[e].rmdb_id + '" class="thumbnail"><p class="lead" style="padding-top:10px;"><span class="label label-default">' + colorRmdbId(data[c].TT_entry[e].rmdb_id) + '</span></p><img src="/site_data/thumbs/' + data[c].TT_entry[e].cid + '.gif"/><br/></a></div>';
				}
				pan_html += '</div>';
			}
			if (data[c].MM_entry.length) {
				...
				for (e in data[c].MM_entry) {
					pan_html += '<div class="col-md-4 entry-list"><a href="/repository/detail/' + data[c].MM_entry[e].rmdb_id + '" class="thumbnail"><p class="lead" style="padding-top:10px;"><span class="label label-default">' + colorRmdbId(data[c].MM_entry[e].rmdb_id) + '</span></p><img src="/site_data/thumbs/' + data[c].MM_entry[e].cid + '.gif"/><br/></a></div>';
				}
				pan_html += '</div>';
			}
			if (data[c].MA_entry.length) {
				...
				for (e in data[c].MA_entry) {
					pan_html += '<div class="col-md-4 entry-list"><a href="/repository/detail/' + data[c].MA_entry[e].rmdb_id + '" class="thumbnail"><p class="lead" style="padding-top:10px;"><span class="label label-default">' + colorRmdbId(data[c].MA_entry[e].rmdb_id) + '</span></p><img src="/site_data/thumbs/' + data[c].MA_entry[e].cid + '.gif"/><br/></a></div>';
				}
				pan_html += '</div>';
			}
