function draw_heatmap(json) {
    ...
    svg.append("text").text(Array(temp_lbl).join('W'))
        ...
        .remove();
    temp_lbl = d3.max(col_names, function(d) { return d.length; });
    svg.append("text").text(Array(temp_lbl).join('W'))
    ...
    var y_label_bg = svg.selectAll("g")
                    ...
                    .attr("y", function(d, i) { return (i + 0.8) * (h + 0.5) + main_margin.top;})
    ...
    var x_label_bg = svg.selectAll("g")
                    ...
                    .attr("text-anchor", "start")
                    .attr("transform", function(d, i) { return "rotate(-90)translate(" + (-main_margin.top + 15) + "," + ((i + 0.8) * (h + 0.5) + main_margin.left) + ")"; })
                    .attr("font-size", 12).attr("font-family", "Arial");
    var x_label2_bg = svg.selectAll("g")
                    ...
                    .attr("text-anchor", "start")
                    .attr("transform", function(d, i) { return "rotate(-90)translate(" + (-main_margin.top + 5) + "," + ((i + 0.8) * (h + 0.5) + main_margin.left) + ")"; })
                    .attr("font-size", 12).attr("font-family", "Arial")
                    .attr("fill", "white");
    ...
    var x_num_bg = svg.selectAll("g")
                    ...
                    .attr("class", "num")
                    .attr("text-anchor", "end")
                    .attr("transform", function(d, i) { return "rotate(-90)translate(" + (-main_margin.top - total_h - 5) + "," + ((i + 0.8) * (h + 0.5) + main_margin.left) + ")"; })
                    .attr("font-size", 12).attr("font-family", "Arial");
                        ...
                        .on("mouseover", function(d) {
                            ...
                            timer = setTimeout(function() {
                                div.transition().duration(200)
                                    .style("opacity", 0.9);
                                div.html('<table><tr><td><p><span class="label label-violet pull-right">ROW</span></p></td><td><p>&nbsp;&nbsp;<span class="label label-orange">' + (y_cord + 1) + '</span>: ' + row_names[y_cord] + '</p></td></tr><tr><td><p><span class="label label-violet pull-right">COLUMN</span></p></td><td><p>&nbsp;&nbsp;<span class="label label-orange">' + (x_cord + 1) + '</span>: ' + col_names[x_cord] + '</p></td></tr><tr><td><p><span class="label label-primary pull-right">SEQUENCE</span></p></td><td><p>&nbsp;&nbsp;' + d.seq + '</p></td></tr><tr><td><p><span class="label label-success pull-right">REACTIVITY</span></p></td><td><p>&nbsp;&nbsp;' + d.val + '</p></td></tr><tr><td><p><span class="label label-dark-red pull-right">ERROR</span></p></td><td><p>&nbsp;&nbsp;' + d.err + '</p></td></tr></table>')  
                                    .style("left", pageX + "px")
