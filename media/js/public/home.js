  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      for (var d in data) {
        ...
        body_html += '<div class="item" style="height:300px;"><br/><br/><div class="row"><p class="text-center"><a href="/detail/' + data[d].rmdb_id + '" target="_blank"><span class="label label-default">' + colorRmdbId(data[d].rmdb_id) + '</span><br/>' + data[d].name + '</a></p></div><div class="row"><a href="/detail/' + data[d].rmdb_id + '" target="_blank"><img src="/site_data/thumbnail/' + data[d].rmdb_id + '.gif" class="center-block"/></a></div></div>';
      }
