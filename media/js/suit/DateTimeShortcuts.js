...
var DateTimeShortcuts = {
    ...
    addClock: function(inp) {
        ...
        quickElement('img', clock_link, '', 'src', '/site_media/admin/img/icon_clock.gif', 'alt', gettext('Clock'));
    ...
    addCalendar: function(inp) {
        ...
        quickElement('img', cal_link, '', 'src', '/site_media/admin/img/icon_calendar.gif', 'alt', gettext('Calendar'));
